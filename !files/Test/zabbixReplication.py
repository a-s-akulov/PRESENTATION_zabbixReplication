...
class ZabbixReplication():
    ...
    def __init__(self):
        ...
        self.GROUPS = {
            '15': ([8], ["36497", "36498"], "0"), # IPSec = ([Роутер], 10263 Template, NoProxy)
            '19': ([6, 19], ["36499","36500"], "36505"), # Камеры = ([Камера, Камера (кабинет)], 12946 Template, NoProxy)
            '16': ([14], ["36501"], "36506"), # WAN1 = (WAN1, 10264 Template, NoProxy)
            '17': ([21], ["36502"], "0"), # WAN2 = (WAN2, 10317 Template, NoProxy)
            '34': ([20], ["36503","36504"], "36506"), # KKT = (ККТ, 14306 Template, proxyid='26037')
        }
