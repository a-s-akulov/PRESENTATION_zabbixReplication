...
class ZabbixReplication():
    ...
    def __init__(self):
        ...
        self.GROUPS = {
            '15': ([8], ["10263", "10386"], "0"), # IPSec = ([Роутер], Templates=["10263", "10386"], NoProxy)
            '19': ([6, 19], ["12946","12942"], "12064"), # Камеры = ([Камера, Камера (кабинет)], Templates=["12946","12942"], proxyid='12064')
            '16': ([14], ["10264"], "13958"), # WAN1 = (WAN1, Templates=["10264"], proxyid='13958')
            '17': ([21], ["10317"], "0"), # WAN2 = (WAN2, Templates=["10317"], NoProxy)
            '34': ([20], ["14306","16592"], "13958"), # KKT = (ККТ, Templates=["14306","16592"], proxyid='13958')
        }
