...
class ZabbixReplication():
    ...
    def __init__(self):
        ...
        self.GROUPS = {
            '15': ([8], ["10263", "10386"], "0"), # IPSec = ([Роутер], 10263 Template, NoProxy)
            '19': ([6, 19], ["12946","12942"], "12064"), # Камеры = ([Камера, Камера (кабинет)], 12946 Template, NoProxy)
            '16': ([14], ["10264"], "13958"), # WAN1 = (WAN1, 10264 Template, NoProxy)
            '17': ([21], ["10317"], "0"), # WAN2 = (WAN2, 10317 Template, NoProxy)
            '34': ([20], ["14306","16592"], "13958"), # KKT = (ККТ, 14306 Template, proxyid='26037')
        }

        # Maintenance groups: City timezone = Zabbix hostGroup (zabbix group in some maintenance group)
        self.maintenanceGroups = {
            2: "65",
            3: "56", # timezone 3: Moscow = zabbix hostGroup '56'
            4: "57",
            5: "58",
            6: "59",
            7: "60",
