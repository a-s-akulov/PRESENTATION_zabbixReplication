class MyDict(dict):
    ...
    def __getitem__(self, item):
        return self.get(item) if item in self else self.default
...
class FncsSQL():
    ...
    def __init__(self, parent, sqlModule):
        ...
        self.sqlShops = {}
        self.sqlHostTypes = {}
        self.sqlCities = MyDict(default=None)
    ...
    def get_sql_data(self):
        ...
        # SHOPS
        query = "SELECT PT_ID, PT_FULLNAME, TIME_ZONE FROM dbo.PARTNERS where TP_ID != 10"
        self.send_sql_request(cur, query, self.sqlShops, "shops")
        ...
        try:
            ...
            while True:
                ...
                if mode == 0:
                    ...
                    str_ = row[1]
                    variable[row[0]] = str_
                    str_ = MAIN.city_from_str(str_)
                    self.sqlCities[str_] = row[2]
